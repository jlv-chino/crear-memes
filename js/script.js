        ...
        if (this.imagen.files && this.imagen.files[0]){
            ...
            lector.onload = () => {
                ...
                image.onload = () => {
                    ...
                    let tamanioFuente = ((this.imagenCanvas.width + this.imagenCanvas.height) /2) * 4 / 100;
                    contexto.font = `${tamanioFuente}pt sans-serif`;
                    contexto.textAlign = "center";
                    contexto.textBaseline = "top";

                    contexto.lineJoin = "round";
                    contexto.lineWidth = tamanioFuente/5;
                    ...
                    this.redimensionarCanvas(this.imagenCanvas.heigh, this.imagenCanvas.width);
                };
